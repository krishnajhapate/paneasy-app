  ...
  return ThemeData(
    textTheme: TextTheme(
      ...
      headlineMedium: TextStyle(
          fontSize: 22, color: Color(0xff5E249F), fontWeight: FontWeight.bold),
      bodyLarge: TextStyle(
        fontSize: 15,
        color: Colors.black,
      ),
      ...
      titleMedium: TextStyle(
          color: Color(0xff5E249F), fontSize: 16, fontWeight: FontWeight.bold),
    ...
    primaryColor: Color(0xff5E249F),
    primarySwatch: MaterialColor(0xff5E249F, color),
    ...
    textButtonTheme: TextButtonThemeData(
        style: ButtonStyle(
      backgroundColor: MaterialStateProperty.all(Color(0xff5E249F)),
    ...
    appBarTheme: AppBarTheme(
        color: Colors.white,
        elevation: 10,
        shadowColor: Color(0xff5E249F).withOpacity(0.09),
        actionsIconTheme: IconThemeData(
          color: Color(0xff5E249F),
        ),
        titleTextStyle: TextStyle(
